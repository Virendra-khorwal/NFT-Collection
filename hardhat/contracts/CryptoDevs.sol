...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    // _price is the price of one Crpto Dev NFT
    ...
    name is our case is `Crypto Devs` and symbol is `CD`.
  ...
  */
    ...
    */
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        tokenId += 1;
        // _safeMint is a safer version of the _mint function as it ensures that if the address being minted to is a contract, then it knows how to deel with ERC721 tokens. If the address being minted to is not a contract, it works the same way as _mint
    ...
    */
    ...
    /*
    @dev _baseURI overided the Openzeppelin's ERC721 implementation which by default returned an empty string for the baseURI
    */
